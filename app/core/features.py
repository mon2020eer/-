...
النسختان:
    ...
    **المتقدّمة** (pro): ما سبق + تقارير مالية وتصدير، ونسخ احتياطي على Google
    Drive، وصيانة ومخالفات، وتحليل ربحية كل سيارة وعائد استثمارها، واحتساب
    بالساعة، وتعدّد المستخدمين والعملات، وسجلّ تدقيق.
...
FEATURES = {
    ...
    TIER_PRO: {
        ...
        "alerts", "contract_template", "profitability",
    },
...
FEATURE_LABELS = {
    "profitability": "تحليل ربحية السيارات وعائد الاستثمار",
